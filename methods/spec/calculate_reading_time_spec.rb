...
RSpec.describe "calculate_reading_time method" do
  ...
  context "gives a text of under 200 words" do
    it "returns one" do
  ...
  context "gives a text of two hundred words" do
    it "returns one" do
  ...
  context "gives a text of three hundred words" do
    it "returns two" do
  ...
  context "gives a text of four hundred words" do
    it "returns two" do
  ...
  context "gives a text of five thousand words" do
